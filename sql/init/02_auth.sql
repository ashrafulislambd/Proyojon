...
BEGIN
    ...
    INSERT INTO users (name, email, password_hash, phone, nid_info, address, credit_limit, kyc_status)
    VALUES (
        p_name,
        LOWER(p_email),
    ...
    VALUES (v_user_id, 'plan_change', 'Welcome to Proyojon!',
        'Your account has been created. Complete KYC verification to unlock higher credit limits.');
