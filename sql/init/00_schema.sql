...
CREATE TABLE merchants (
    ...
    pending_settlement DECIMAL(10, 2) DEFAULT 0.00,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE orders (
    ...
    payment_plan VARCHAR(20) DEFAULT 'full' CHECK (payment_plan IN ('full', '3months', '6months', '12months')),
...
CREATE TABLE transactions (
    ...
    type VARCHAR(20) DEFAULT 'payment' CHECK (type IN ('payment', 'refund', 'late_fee')),
